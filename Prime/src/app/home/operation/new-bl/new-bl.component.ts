...
export class NewBlComponent implements OnInit {
  ...
  createBL() {
    ...
    this.blForm.get('CREATED_BY')?.setValue(this._commonService.getUserName());
              ...
              if (this.i == 0) {
                ...
                add.push(
                  this._formBuilder.group({
                    ...
                    NO_OF_CONTPKG: [this.groupedList[this.i]],
                    KIND_OF_GOODS: [
                      element.DESC_OF_GOODS.substr(
                        550,
                        element.DESC_OF_GOODS.length - 1
                      ),
                    ],
                    MKS_NO: [
  ...
  async generateAnnexurePdf() {
    ...
    let docDefinition1 = {
      header: (currentPage: any) => {
        return [
          {
            text: 'ANNEXURE for BL ' + this.blForm.value.BL_NO,
            bold: true,
            fontSize: 10,
            alignment: 'center',
          },
      ...
      content: [
        {
          table: {
            //heights: [15],
            widths: [60, 60, 60, 60, 70, 40, 40, 40],
            headerRows: 1,
            body: [
              [
                {
        ...
        content: [
                ...
                },
                {
                  columns: [
                    ...
                    [
                      ...
                      {
                        text: this.blForm.value.PORT_OF_LOADING.split(
                          '('
                        )[0].toUpperCase(),
                        fontSize: 7,
                      },
          ...
          },
          {
            columns: [
              [
                ...
                {
                  text: this.blForm.value.PORT_OF_DISCHARGE.split(
                    '('
                  )[0].toUpperCase(),
                  fontSize: 7,
                },
            ...
            table: {
              ...
              body: [
                [
                  ...
                  },
                  {
                    text: [
                      ...
                      {
                        text: "Shipper's Load Stow & Count",
                        fontSize: 9,
                        bold: true,
                      },
                    ],
                ...
                ...this.ContainerList1.slice(
                  ...
                  {
                    text:
                      p.SEAL_NO == null || p.SEAL_NO == ''
                        ? p.CONTAINER_NO + '/\n' + p.AGENT_SEAL_NO
                        : p.AGENT_SEAL_NO == null || p.AGENT_SEAL_NO == ''
                        ? p.CONTAINER_NO + '/\n' + p.SEAL_NO
                        : p.CONTAINER_NO +
                          '/\n' +
                          p.SEAL_NO +
                            ...
                            [
                              ...
                              // },
                              {
                                text:
                                  ...
                                  this.blForm.value.NO_OF_ORIGINAL_BL,
                                fontSize: 8,
                                bold: true,
                              },
                              {
                                text:
                                  ...
                                  '\n' +
                                  'Name: ' +
                                  this.destinationAgent?.ORG_NAME +
                                  '\n' +
                                  'Address: ' +
                                  this.destinationAgent?.ORG_ADDRESS1 +
                                  '\n' +
                                  'Contact: ' +
                                  this.destinationAgent?.CONTACT +
                                  '\n' +
                                  'Email: ' +
                                  this.destinationAgent?.EMAIL +
                                  '\n' +
                                  'Fax No: ' +
                                  this.destinationAgent?.FAX,
                                fontSize: 7,
                                bold: true,
                              },
                            ],
          ...
          },
          {
            columns: [
              ...
              [
                {
                  text: 'As Agents for the carrier',
                  fontSize: 8,
                  margin: [0, 0, 0, 0],
                },
                {
                        ...
                        table: {
                          ...
                          body: [
                            [
                              ...
                              { text: 'Measurement', fontSize: 8, bold: true },
                            ],
                            ...
                            [
                              ...
                              { text: ' ', fontSize: 7 },
                              {
                                text: this.ContainerList1[0].DESC_OF_GOODS.substr(
                                  550,
                                  this.ContainerList1[0].DESC_OF_GOODS.length -
                                    1
                                ),
                                fontSize: 7,
                              },
                        ...
                        table: {
                          ...
                          body: [
                            ...
                            ...this.ContainerList1.slice(5).map((p: any) => [
                              ...
                              {
                                rowSpan: this.ContainerList1.length - 5,
                                text: p.MKS_NO,
                                fontSize: 7,
                              },
                              { text: '   -', fontSize: 7 },
