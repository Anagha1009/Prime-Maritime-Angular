...
export class ErDetailsComponent implements OnInit {
  ...
  constructor(private _erService: ErService) { }
  ...
  getErDetails() {
    ...
    this._erService.getERDetails(this.repoNo,this.agentCode,this.depoCode).subscribe((res: any) => {
      if (res.ResponseCode == 200) {
        this.er = res.Data;
        console.log(this.er);
      }
    });
    this._erService.getERContainerDetails(this.repoNo,this.agentCode,this.depoCode).subscribe((res:any)=>{
      if (res.ResponseCode == 200) {
